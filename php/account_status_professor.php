                            ...
                            <hr>
                                    <div class="row" id="border-bg">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <button onclick="verifyProfessor(<?php echo $row_professor['professor_id'] ?>)" class="btn btn-danger w-btn-acc sm-btn-font-size">Deny</button>
                                            <button onclick="denyProfessor(<?php echo $row_professor['professor_id'] ?>)" class="btn btn-primary w-btn-acc sm-btn-font-size">Verify</button>
